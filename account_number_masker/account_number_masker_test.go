...
func TestMask(t *testing.T) {
	testCases := []struct {
		...
		{value: "ROCKY MOUNTAIN P BILL P *******8001 REF # 011258000923225", expected: "ROCKY MOUNTAIN P BILL P *******8001 REF # XXXXXXXXXXX3225"},
		...
		{value: "CHECK CRD PURCHASE 03/23 EDDIE BAUER 0835 OREM UT 486831XXXXXX6803 162083833088519 ?MCC=5655", expected: "CHECK CRD PURCHASE 03/23 EDDIE BAUER 0835 OREM UT 486831XXXXXX6803 XXXXXXXXXXX8519 ?MCC=5655"},
		{value: "CHECK 01069, 0873066630", expected: "CHECK 01069, 0873066630"},
